                                    ...
                                    <CardBody>
                                        <div id="checkout-nav-pills-wizard" className="twitter-bs-wizard">
                                            ...
                                            <ul className="pager wizard twitter-bs-wizard-pager-link">
                                                ...
                                                <li className={this.state.activeTab === 3 ? "next disabled" : "next"}><Link to="#" className="btn btn-success" onClick={() => { this.toggleTab(this.state.activeTab + 1);} }>Complete order </Link></li>
                                            </ul>
                                        </div>
                                    </CardBody>
                                </Card>
